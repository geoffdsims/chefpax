...
export function getProductsWithInventory(): Product[] {
  return [
    ...
    // PREMIUM 5×5 LINE - Individual items
    {
      _id: "shiso-5x5",
      sku: "SHISO_5X5",
      name: "Shiso (Korean Perilla) — 5×5",
      priceCents: 1500,
      unit: "tray",
      active: true,
      sort: 24,
      ...
      description: "Mint-basil blend with cinnamon notes. 5×5 premium tray. Perfect for sushi, cocktails. 14-18 days to harvest.",
      leadTimeDays: 18,
      isSubscriptionEligible: true,
      stages: [
        { type: "SEED", offsetDays: 0, notes: "1g surface sow, press gently" },
        { type: "GERMINATE", offsetDays: 0, durationDays: 5, notes: "Light required, mist 2x daily" },
        { type: "LIGHT", offsetDays: 5, durationDays: 12, notes: "12-16h light, Tier 5" },
        { type: "HARVEST", offsetDays: 18, notes: "Day 14-18" },
    ...
    },
    {
      ...
      currentWeekAvailable: 3,
      photoUrl: "/images/amaranth_dreads.png",
      description: "Vibrant magenta microgreens, earthy beet-like flavor. 5×5 premium tray. Chef-favorite garnish. 10-12 days.",
      leadTimeDays: 12,
      isSubscriptionEligible: true,
      stages: [
        { type: "SEED", offsetDays: 0, notes: "1g surface sow, no cover" },
        { type: "GERMINATE", offsetDays: 0, durationDays: 3, notes: "Light required, 2-4 days" },
        { type: "LIGHT", offsetDays: 3, durationDays: 8, notes: "Continuous light, Tier 5" },
        { type: "HARVEST", offsetDays: 12, notes: "Day 10-12" },
    ...
    },
    {
      ...
      currentWeekAvailable: 3,
      photoUrl: "/images/chefPax_logo.png",
      description: "Purple basil with sweet clove notes. 5×5 premium tray. Beautiful contrast. 12-15 days.",
      leadTimeDays: 15,
      isSubscriptionEligible: true,
      stages: [
        { type: "SEED", offsetDays: 0, notes: "1.5g broadcast, light mist" },
        { type: "GERMINATE", offsetDays: 0, durationDays: 5, notes: "Light from Day 0" },
        { type: "LIGHT", offsetDays: 5, durationDays: 9, notes: "12-16h light" },
        { type: "HARVEST", offsetDays: 15, notes: "Day 12-15" },
    ...
    },
    {
      ...
      currentWeekAvailable: 3,
      photoUrl: "/images/chefPax_logo.png",
      description: "Citrusy sweet basil. 5×5 premium tray. Perfect for cocktails, desserts. 12-15 days.",
      leadTimeDays: 15,
      isSubscriptionEligible: true,
      stages: [
        { type: "SEED", offsetDays: 0, notes: "1.5g broadcast, light mist" },
    ...
    },
    {
      ...
      currentWeekAvailable: 3,
      photoUrl: "/images/chefPax_logo.png",
      description: "Anise and spice notes. 5×5 premium tray. Perfect for Asian dishes. 12-15 days.",
      leadTimeDays: 15,
      isSubscriptionEligible: true,
      stages: [
        { type: "SEED", offsetDays: 0, notes: "1.5g broadcast, warmth helps" },
        { type: "GERMINATE", offsetDays: 0, durationDays: 5, notes: "Light from Day 0, 74°F" },
        { type: "LIGHT", offsetDays: 5, durationDays: 9, notes: "14h light, Tier 4-5" },
        { type: "HARVEST", offsetDays: 15, notes: "Day 12-15" },
        { type: "PACK", offsetDays: 15, notes: "Package for delivery" }
      ],
      subscriptionEnabled: true,
