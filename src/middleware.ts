...
export async function middleware(request: NextRequest) {
  ...
  if (process.env.NODE_ENV === 'production') {
    response.headers.set(
      ...
      "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://js.stripe.com https://www.googletagmanager.com https://maps.googleapis.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://api.stripe.com https://vitals.vercel-insights.com https://maps.googleapis.com https://o4510202144358401.ingest.us.sentry.io; frame-src 'self' https://js.stripe.com; worker-src 'self' blob:;"
    );
  }
